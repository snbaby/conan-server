...
public interface UserInfoMapper {
	...
	long userRegister(@Param("range_date_start") String range_date_start,@Param("range_date_end") String range_date_end);
	long userLogin(@Param("range_date_start") String range_date_start,@Param("range_date_end") String range_date_end);
