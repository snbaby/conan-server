...
public interface RechargeBillMapper {
	...
	long rechargeUser(@Param("range_date_start") String range_date_start,@Param("range_date_end") String range_date_end);
	long rechargeItems(@Param("range_date_start") String range_date_start,@Param("range_date_end") String range_date_end);
	Double rechargeRmb(@Param("range_date_start") String range_date_start,@Param("range_date_end") String range_date_end);
	Double totalRechargeRmb();
	Double rechargeGold(@Param("range_date_start") String range_date_start,@Param("range_date_end") String range_date_end);
	Double totalRechargeGold();
