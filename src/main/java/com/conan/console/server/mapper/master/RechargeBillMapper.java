...
public interface RechargeBillMapper {
	...
	int selectNewRechargeCntTotal();
	int selectTdRechargeAgreeCntTotal(@Param("td") Date td);
	int selectTdRechargeAgreeAmountTotal(@Param("td") Date td);
	int selectTtRechargeAgreeAmountTotal();
