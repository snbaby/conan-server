...
public class DetectionController {
	...
	@PostMapping("get_scan_history_export_link")
	public ResponseEntity<ResponseSuccessResult> getScanHistoryExportLink(HttpServletRequest request,@RequestBody @Valid UserGetScanHistoryParameters userGetScanHistoryParameters, BindingResult bindingResult) {
		if (bindingResult.hasErrors()) {
			throw new ConanException(ConanExceptionConstants.PARAMETER_EXCEPTION_CODE,
					ConanExceptionConstants.PARAMETER_EXCEPTION_MESSAGE, bindingResult.getFieldError(),
					ConanExceptionConstants.PARAMETER_EXCEPTION_HTTP_STATUS);
